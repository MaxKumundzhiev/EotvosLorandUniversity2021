...
The 3 resulting random pipeline predictions can be observed on Figure \ref{fig:predictions} which represents predictions themselves as well as additional impacting information as ground-truth and localization error. 
\begin{figure}[h]
