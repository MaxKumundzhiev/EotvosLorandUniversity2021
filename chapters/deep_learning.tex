...
\begin{figure}[h]
    \centering \includegraphics[width=7cm]{images/neuron_biological_model.jpg}
...
\[ = x_1[w_2^3 \cdot w_1^2 + w_1^3 \cdot w_1^1] + \]
\[   x_2[w_2^3 \cdot w_2^2 + w_1^3 \cdot w_2^1] + \]
\[   [w_2^3 \cdot b^2+w_1^3 \cdot b^1+b^3]  = \]
...
\section{Unet}
% TODO: correct expansive path description
