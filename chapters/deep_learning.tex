...
def crop(original_tensor, target_tensor):
  ...
  delta = (original_size - target_size) // 2
  return tensor[:, :, delta:original_size-delta, delta:original_size-delta] 
...
class Unet(nn.Module):
  def __init__(self):
    ...
    self.up_trans_1 = nn.ConvTrasnpose2d(input_channels=1024, output_channels=512, kernel_size=2, stride=2)
    self.up_conv_1 = double_conv(1024, 512)
    
    self.up_trans_2 = nn.ConvTrasnpose2d(input_channels=512, output_channels=256, kernel_size=2, stride=2)
    self.up_conv_2 = double_conv(512, 256)
    
    self.up_trans_3 = nn.ConvTrasnpose2d(input_channels=256, output_channels=128, kernel_size=2, stride=2)
    self.up_conv_3 = double_conv(256, 128)
    
    self.up_trans_4 = nn.ConvTrasnpose2d(input_channels=128, output_channels=64, kernel_size=2, stride=2)
    self.up_conv_4 = double_conv(128, 64)
    
    self.out = nn.Conv2d(input_channels=64, output_channels=2, kernel_size=1)
