...
The notion of segmentation within image analysis stands for the process of classifying pixels into groups which corresponds to the same tissue type. Segmentation has many uses cases like a 'measure volume of an organ', 'render a 3D view of an organ', 'surface-based registration' and many others. 

\section{Classical Segmentation Methods} 
@TODO add more mindful context
Below I will introduce the classical approaches to segment images. 
