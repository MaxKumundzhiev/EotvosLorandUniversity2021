...
In medical image analysis the challenges are fascinating and so are the rewards. When we solve problems in medical imaging, we literally serve humanity. Nowadays, medical imaging is widely different rather than even couple of years ago moreover than other areas of image processing. 

Mutually I will show the basic techniques in medical imaging. It's an immense area so I will pick a few particular specimens.
