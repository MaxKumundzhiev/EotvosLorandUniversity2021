...
\begin{figure}[h]
    \centering \includegraphics[width=4cm]{images/unet.png}
...
\begin{figure}[h]
    \centering \includegraphics[width=4cm]{images/DoubleU-Net.png}
    \caption {DoubleU-Net architecture.}
    \label{fig:double_unet}
    \small source by: \url{https://arxiv.org/pdf/2006.04868v2.pdf}
\end{figure}
